...
class setting_config:
    ...
    network = 'swin_unet'  # todo:['unet', 'rcnn_unet', 'atten_unet', 'atten_rcnn_unet', 'nested_unet', 'swin_unet','transunet_R50' ]
    ...
    if datasets == 'isic18':
        ...
        data_path = '/data/glw/Projects/mmsegmentation/projects/KneeCartilage02_UNet/CartilageData_202409_202411/'   # todo
        # data_path = '/home/data/glw/Projects/CartilageData_all/'    # todo:[此时要修改VM_UNet/datasets/dataset.py 中第42行的mask转化为0，1数值的式子（mask/256）]
        # data_path = '/home/data/glw/Projects/VM_UNet/data_medaugment/'
    elif datasets == 'polyp':
        # data_path = '/home/data/glw/Projects/PolypDatasets/'
        data_path = '/home/data/glw/Projects/VM_UNet/polyp_medaugment/' # todo: medaugment 增强处理后的数据集
    elif datasets == 'clinicDB':
        data_path = '/home/data/glw/Projects/PolypDatasets/ClinicDB_Train/'
    elif datasets == 'kvasir':
        data_path = '/home/data/glw/Projects/PolypDatasets/Kvasir_Train/'
    else:
    ...
    work_dir = 'UNets_results/' + network + '_' + datasets + '_' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
