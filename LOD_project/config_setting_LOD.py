...
from VM_UNet.LOD_project.utils_LOD import *
...
class setting_config:
    ...
    datasets = 'cartilage'   #todo: 'cartilage' # 'polyp'  ,'kvasir'         # set dataset path
    if datasets == 'isic18':
        ...
        data_path = '/VM_UNet/polyp_medaugment/'  # todo: medaugment 增强处理后的数据集
    elif datasets == 'clinicDB':
        data_path = '/PolypDatasets/ClinicDB_Train/'
    elif datasets == 'kvasir':
        data_path = '/PolypDatasets/Kvasir_Train/'
    else:
    ...
    print_interval = 20
    val_interval = 20        # 30
    save_interval = 2       # output interval during testing
    threshold = 0.5
