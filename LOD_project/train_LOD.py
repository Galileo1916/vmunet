...
# todo
from VM_UNet.LOD_project.vmunet_LOD import VMUNet_LOD
# from models.vmunet.vmunet import VMUNet

from VM_UNet.LOD_project.engine_LOD import *
# from engine_advchain import *
import sys
...
def main(config):
    ...
    if config.network == 'vmunet':
        model = VMUNet_LOD(
            ...
            load_ckpt_path=model_cfg['load_ckpt_path'],   # 【注释掉】如果不加载预训练模型
        )
        model.load_from()
